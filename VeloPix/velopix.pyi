...
Validation methods
"""
def validate_print(py_events: List[Dict[str, Any]], py_tracks: List[List[Track]]) -> None: ...
def validate_efficiency(py_events: List[Dict[str, Any]], py_tracks: List[List[Track]], particle_type: str) -> float: ...
def validate_to_json(py_events: List[Dict[str, Any]], py_tracks: List[List[Track]], verbose: bool) -> Dict[str, Any]: ...
def validate_to_json_nested(py_events: List[Dict[str, Any]], py_tracks: List[List[Track]], verbose: bool) -> Dict[str, Any]: ...